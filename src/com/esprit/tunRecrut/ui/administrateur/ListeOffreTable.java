 ...
 * @author app4mob
 */
public class ListeOffreTable extends AbstractTableModel {

    String[] colonnes = {"Id", "Etat","User", "Titre", "Type de contrat", "Experience", "Type", "Niveau", "Region"};
    List<Annonce> ligne = new ArrayList<Annonce>();

    public ListeOffreTable() {
      //  UserDAO userdao = new UserDAO();
      //  ligne = userdao.getAllCandidat();
    }

    public ListeOffreTable(String text,int contrat_id, int experience_id, int type_id, int niveau_id, int region_id, int type) {
